...
def makeDirs(context):
  if ((context.win32 == 1 or context.linux32 == 1) and not os.path.exists(context.TARGET_DEBUG_32)):
  ...
  if ((context.win64 == 1 or context.linux64 == 1) and not os.path.exists(context.TARGET_DEBUG_64)):
