...
class ABASE_API ATextConverter
{
  public:
    ...
    */
    static void encode64(const AString& strSource, AOutputBuffer&, const AString& strCharSet = sm__strAlphaNumCharacterSet);
    static void decode64(const AString& strSource, AOutputBuffer&, const AString& strCharSet = sm__strAlphaNumCharacterSet);
  ...
  private:
    ...
    */
    static const AString sm__strBase64CharacterSet;
    ...
    "9kB7CtIyE8FwGH-fKbL6MjNOPQRSTarUl3VcWvx5YZ_dD14ghiXm0noDspJquz2e";
     ...
     0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF
    */
    static const AString sm__strAlphaNumCharacterSet;
};
