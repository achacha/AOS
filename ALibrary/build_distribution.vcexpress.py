...
if (buildtype == "debug" or buildtype == "all"):
	...
	makeSystemCall(vc+" ALibrary.sln /"+buildmode+" Debug /project UnitTests");
	print "|------DEBUG BUILD: ALibraryImpl---------------------------|";
	makeSystemCall(vc+" ..\ALibraryImpl\ALibraryImpl.sln /"+buildmode+" Debug /project ConsoleImpl");

if (buildtype == "release" or buildtype == "all"):
	print "|----RELEASE BUILD: ALibrary-------------------------------|";
	makeSystemCall(vc+" ALibrary.sln /"+buildmode+" Release /project UnitTests");
	print "|----RELEASE BUILD: ALibraryImpl---------------------------|";
	makeSystemCall(vc+" ..\ALibraryImpl\ALibraryImpl.sln /"+buildmode+" Release /project ConsoleImpl");
