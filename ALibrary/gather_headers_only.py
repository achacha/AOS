...
syncPath(os.path.join(TARGET_BASE_PATH, "ALibraryImpl", "ADatabase_SQLite", "sqlite-3_5_1", "sqlite3.h"), TARGET_ALIBRARY_INCLUDE_PATH);
...
syncPath(os.path.join(TARGET_BASE_PATH, "ALibraryImpl", "ALuaEmbed", "lua-5.1.3", "src", "*.h"), TARGET_ALIBRARY_INCLUDE_PATH);
