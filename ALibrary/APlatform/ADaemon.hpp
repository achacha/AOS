...
$Id: ADaemon.hpp 300 2009-09-14 21:13:08Z achacha $
*/
...
extern "C"
{
  APLATFORM_API DWORD WINAPI fcbServiceHandler(DWORD dwControl, DWORD dwEventType, LPVOID lpEventData, LPVOID lpContext);

#  ifdef UNICODE
  APLATFORM_API VOID WINAPI fcbServiceMain(DWORD argc, LPTSTR *argv);
#  else
  APLATFORM_API VOID WINAPI fcbServiceMain(DWORD argc, LPSTR *argv);
#  endif
}

#endif

class APLATFORM_API ADaemon
{
public:
  /*!
  UNIX and NT
