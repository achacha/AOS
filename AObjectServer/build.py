...
if (buildtype == "debug" or buildtype == "all"):
	...
	makeSystemCall("devenv AObjectServer.sln /"+buildmode+" Debug /project AObjectServer");

if (buildtype == "release" or buildtype == "all"):
	print "|----RELEASE BUILD: ALibrary-------------------------------|";
	makeSystemCall("devenv AObjectServer.sln /"+buildmode+" Release /project AObjectServer");
